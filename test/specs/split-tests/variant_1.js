...
describe("Split Test", () => {
  it("Send traffic to Variant 1", async () => {
    ...
    do {
      ...
      if (LABEL_TEXT != "Test-1") {
        await browser.refresh();
        await browser.pause(5000);
      }
    } while (LABEL_TEXT != "Test-1");

    await LanderPage.addToCart();
    await browser.pause(5000);
    await Checkout.first_name.setValue("Variant 1");
    ...
    await Checkout.email.setValue("variant_1_@test.com");
